...
const String _kConsumableId = 'Pinnedmonthlyplan';
const String _kSubscriptionId = 'Pinnedmonthlyplan';
...
const List<String> _kiOSProductIds = <String>['Pinnedmonthlyplan'];
//Example
    ...
    purchaseDetailsList.forEach((PurchaseDetails purchaseDetails) async {
      ...
      if (purchaseDetails.status == PurchaseStatus.pending) {
        ...
        if (purchaseDetails.status == PurchaseStatus.error) {
          ...
          print(purchaseDetails.error.code + purchaseDetails.error.details);
          print('errore');
          ...
          if (valid) {
            ...
            print('deleiver profuct');
          } else {
            _handleInvalidPurchase(purchaseDetails);
            print('purchase dertail');
            return;
          }
        }
